# webspatialscan: an R package to enable Spatial Scan Statistics on WebGIS applications through OpenCPU R Server [![DOI](https://zenodo.org/badge/786540545.svg)](https://zenodo.org/doi/10.5281/zenodo.11036381)
